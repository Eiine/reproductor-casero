...
export const getVideos = async (req, res) => {
  // Ajustamos la ruta para subir a la raíz del proyecto (donde está /videos)
  const projectRoot = path.join(__dirname, "..", "..");
  
  const videoFolder = path.join(projectRoot, "/src/videos");
  console.log(`Buscando videos en: ${videoFolder}`);
...
export const playVideo = (req, res) => {
    ...
    const videoPath = path.join(__dirname, "..", "videos", videoName); // Ajusta tu carpeta de videos
